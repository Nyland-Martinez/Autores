...
const EditPage = () => {
    ...
    const updateAutor = async (data, onSuccess, onFail) => {
        try {
            const response = await axios.put(`http://localhost:8000/api/autores/${id}`, data);
...

            {
                author !== null ?
                    <Fragment>
                        ...
                        <AuthorForm onSubmit={updateAutor} preset={author} />
                    </Fragment>
                    :
                    <Typography variant="h5">
